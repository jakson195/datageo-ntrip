      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          <div className="max-w-xl">
            <p className="text-xs font-semibold uppercase tracking-widest text-drone">
              Aplicações
            </p>
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2">
          {sectors.map((sector) => (
            <article
              key={sector.id}
              className={`group relative min-h-[280px] overflow-hidden rounded-2xl border border-card-border bg-gradient-to-br ${sector.gradient} transition hover:border-accent/30 hover:shadow-[0_12px_40px_rgba(0,194,168,0.12)]`}
            >
              <div
              ...
              <div className="relative flex h-full flex-col justify-between p-6 sm:p-8">
                ...
                <div className="mt-auto">
                  <div className="rounded-xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm transition group-hover:border-accent/25 group-hover:bg-white/10">
                    <p className="text-sm font-semibold text-accent">{sector.headline}</p>
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link
            href="#contato"
            className="rounded-full bg-accent px-8 py-3 text-sm font-semibold text-background transition hover:bg-accent-dim"
          >
