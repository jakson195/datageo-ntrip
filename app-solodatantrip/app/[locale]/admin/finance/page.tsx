      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            { label: "Receita anual", value: formatBrl(stats.annualRevenue), color: "text-blue-400" },
            { label: "Clientes trial", value: String(stats.trialCustomers), color: "text-purple-400" },
